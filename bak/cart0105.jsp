    ...
    <header>
      ...
      <%
		...
		//執行 SQL 指令	          
			...
			<TD><div class="number">
                <input type="submit"class="number-button" value="-" onclick="if (this.form.amount.value>1) {this.form.amount.value--;this.form.toDo.value='update';this.form.pid.value=<%=db_pid%>}" />
                <input type="text" value=<%=db_amount%> class="text" id="text" name="amount" readonly='readonly' />
                <input type="submit"class="number-button" value="+" onclick="if (this.form.amount.value<this.form.count.value){this.form.amount.value++;this.form.toDo.value='update';this.form.pid.value=<%=db_pid%>} "/>
            </div></TD>
            <TD><%=db_total%></TD>
			<TD><%=db_count%><input type="hidden" value=<%=db_count%> name="count" /></TD>
			<TD><%=db_status%></TD>
