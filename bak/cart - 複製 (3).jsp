    ...
    <header>
      ...
      <%
		...
		%>
			...
			<TD><div class="number">
                <input type="submit"class="number-button" value="-" onclick="if (this.form.amount.value>1) {this.form.amount.value--;this.form.toDo.value='update';this.form.pid.value=86}" />
                <input type="text" value=3 class="text" id="text" name="amount" readonly='readonly' />
                <input type="submit"class="number-button" value="+" onclick="if (this.form.amount.value<this.form.count.value){this.form.amount.value++;this.form.toDo.value='update';this.form.pid.value=86}"/>
            </div></TD>
            <TD>2550</TD>
			<TD>10<input type="hidden" value=5 name="count" /></TD>
			<TD>上架</TD>
            <TD><button type="submit" class="delete-button" onclick="this.form.toDo.value='delete';this.form.pid.value=86">刪除</button></TD>
            </TR>
