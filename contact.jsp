      ...
      <%
        ...
        <div class="container">
            <form action="action_page.php">
              ...
              <label for="lname">手機號碼</label>
              <input type="text" id="lname" name="cellphone" placeholder="手機號碼">
          
              <label for="province">居住地</label>
              ...
              <label for="subject">意見</label>
              <textarea id="subject" name="subject" placeholder="想說的話" style="height:200px"></textarea>
