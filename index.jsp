...
<body>
  ...
  <div class="brand-area">
	  ...
	  %>
      訪客人數:<%=application.getAttribute("count") %>人
      <div class="cart">
  ...
  <section>
    <div class="padding1">
      ...
      <p>
        ...
        只希望在無數可能之中，選出專屬於自己的風景。點此按鈕了解更多資訊。

      </p>       
       <a href="aboutus.html"><input type="button" class="button"value="更多資訊"></a>
      </div>
    <div class="padding2">
      <h2>商店</h2>
      <p>「認真做好每件衣服，分享讓人自信的單純感動。
        力求最舒適的手感、堅持最用心的服務」販售各式男裝，點此按鈕進行參觀。
      </p>
      <a href="shop.jsp"><input type="button" class="button"value="更多資訊"></a>
    </div>
    <div class="padding1">
      <h2>熱門商品</h2>
      <div class="row">
        <div class="column">
          <div class="card">
            <img src="image/9.jpg" alt="t-shirt" style="width:100%;height:300px;">
                <div class="container">
                    <h2>棉質素面短袖T恤</h2>
                    <p class="title">NT$900</p>
                    <span class="fa fa-star rate"></span>
                    <span class="fa fa-star rate"></span>
                    <span class="fa fa-star rate"></span>
                    <span class="fa fa-star rate"></span>
                    <span class="fa fa-star"></span>
                    <a href="good5.jsp"><input type="button" class="button2"value="更多資訊"></a>
                </div>
          </div>
        </div>
        ...
        <div class="column">
          <div class="card">
            <img src="image/shirt(1).jpg" alt="shirt" style="width:100%;height:300px;">
                <div class="container">
                  <h2>簡約抗皺親膚長袖襯衫</h2>
                  <p class="title">NT$800</p>
                  <span class="fa fa-star rate"></span>
                  <span class="fa fa-star rate"></span>
                  <span class="fa fa-star rate"></span>
                  <span class="fa fa-star rate"></span>
                  <span class="fa fa-star"></span>
                  <a href="good3.jsp"><input type="button" class="button2"value="更多資訊"></a>
                </div>
            </div>
          </div>
        </div> 
...
<footer>
  ...
  <div class="footer-form">
    ...
    <div class="footer-container" style="background-color:#FFD78C ">
      <input type="text" placeholder="Name" name="name" required>
      <input type="text" placeholder="Email address" name="mail" required>
      <label>
        <input type="checkbox" checked="checked" name="subscribe"> 每日優惠
      </label>
    </div>
