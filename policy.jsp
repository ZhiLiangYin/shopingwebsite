    ...
    <header>
      ...
      <%
        ...
        <div class="card">
            ...
            <ul>
                <li>信用卡付款<br>
                    方便又好用的付款方式，當您選擇線上刷卡方式進行交易時，作業流程完全保密，保障您的個人隱私資料。</li>
                <li>超商付款取貨<br>
                    適合不方便在家收貨或者不方便使用ATM與無信用卡的消費者。</li>
            </ul>
            <h2>運送方式</h2>
            <ul>
                <li>訂單確認後將立即處理，如您訂單皆現貨商品將於3個工作日收到訂購之商品。</li>
                <li>配送範圍限台灣國內範圍</li>
                <li>以 國內各大物流/超商配送 寄送商品。</li>
            </ul>
            <h2>退貨說明</h2>
            <ul>
                <li>
                    如果您收到的商品，商品不符您所需，在 7 天鑑賞期內』，前往7-11、全家、ok、萊爾富完成包裏退貨手續，若逾期將不再受理。如有任何流程問題，請直接撥打客服0900-613-766。
                </li>
                <li>
                    退款：退款方式會依您使用的付款方式退款
                </li>
                <li>
                    信用卡：如果您是信用卡付款，我們會將您的款項刷退至您當初刷卡付款的信用卡帳戶中。
                </li>
                <li>
                    超商付款取貨：如果您是使用超商付款取貨的付款方式，請您在填寫退貨申請時，務必填寫正確的退款帳號資料，我們將於7個工作天內退款至您的指定帳號中。
                </li>
            </ul>
        </div>
        <footer>
