...
//Step 4: 執行 SQL 指令	
			if(request.getParameter("name") != null && !request.getParameter("name").equals("") && request.getParameter("password") != null && !request.getParameter("password").equals("") && request.getParameter("email") != null && !request.getParameter("email").equals("") && request.getParameter("psw-repeat") != null && !request.getParameter("psw-repeat").equals("") &&request.getParameter("psw-repeat").equals(request.getParameter("password")) ){
				String name=request.getParameter("name");
				String password=request.getParameter("password");
				String email=new String(request.getParameter("email"));
				sql="insert `member` (name,password,email) ";
				sql+="values ('" + name + "', ";
				sql+="'"+  password +"', ";
				sql+="'"+email+"')"; 
				con.createStatement().execute(sql);
				...
				out.println("<script>alert('輸入的資料有誤！');location.href='signup.jsp'</script>");
				con.close();
			}        
		}
    }
