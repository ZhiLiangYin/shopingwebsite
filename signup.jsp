      ...
      <%
        ...
        <form action="add.jsp" method="POST">
            <div class="container">
              ...
              <label for="email"><b>Email</b> Ex. xxx@x.x.x</label>
              ...
              <label for="psw-repeat"><b>暱稱</b></label>
              <input type="nickname" placeholder="nickname" name="name" id="psw-repeat" required>
              <hr>
              <button type="submit" class="registerbtn" onclick="if (checkemail()==false) return false">註冊</button>
            </div>
          </form>
          <footer>
